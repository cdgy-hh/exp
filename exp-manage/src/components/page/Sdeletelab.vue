            ...
            <el-table :data="data" border class="table">
                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" icon="el-icon-circle-plus" @click="handleUpdate(scope.$index, scope.row)">我要删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                axios.post(Global.baseurl+"/exp_stu/stuexp?flag=false&stuid="+this.currUser.userid)
                    .then((response) => {
            ...
            saveUpdate(){
                ...
                axios.post(Global.baseurl+"/exp_stu/cancelexp",request)
                    .then((response) => {
                        var code = response.data.code;
